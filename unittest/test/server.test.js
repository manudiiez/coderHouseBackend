// Para ejecutar los test utilizamos mocha

// Es un packete que se intala de forma global, y al matchMediaponer el comando mocha en la terminal

// Buscara una carpeta llamada test y ejecutara los archivos de adentro

import { strictEqual, deepStrictEqual } from 'assert'
import axios from 'axios'

const enviarNumero = numero => axios.post('http://localhost:8080/ingreso', { numero })
const recibirNumeros = () => axios('http://localhost:8080/regreso')
